...
(function (h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "暂无数据" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No data",
            sInfo: "_START_ to _END_ items，total _TOTAL_ items",
            sInfoEmpty: "from 0 to 0 of 0 entries",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Show _MENU_ items for each page",
            sLoadingRecords: "Loading...",
            sProcessing: "Handling...",
            sSearch: "Search:",
            sSearchPlaceholder: "",
            sUrl: "",
